...
pub fn on_bind_transmitter(request: bind_transmitter, connection_information: &SmppConnectionInformation, _session_id: &String) -> bind_transmitter_resp {
...
pub fn on_bind_receiver(request: bind_receiver, connection_information: &SmppConnectionInformation, _session_id: &String) -> bind_receiver_resp {
...
pub fn on_bind_transceiver(request: bind_transceiver, connection_information: &SmppConnectionInformation, _session_id: &String) -> bind_transceiver_resp {
...
pub fn on_unbind(request: unbind, connection_information: &SmppConnectionInformation, _session_id: &String) -> unbind_resp {
    info!("[unbind@{}] <{}> {:?}", connection_information.server_address, connection_information.client_address, request);
    request.accept()
}

pub fn on_submit_sm(request: submit_sm, connection_information: &SmppConnectionInformation, _session_id: &String) -> submit_sm_resp {
...
pub fn on_cancel_sm(request: cancel_sm, connection_information: &SmppConnectionInformation, _session_id: &String) -> cancel_sm_resp {
    info!("[cancel_sm@{}] <{}> {:?}", connection_information.server_address, connection_information.client_address, request);
    request.accept()
}

pub fn on_deliver_sm_resp(response: deliver_sm_resp, connection_information: &SmppConnectionInformation, _session_id: &String)  {
    info!("[deliver_sm_resp@{}] <{}> {:?}", connection_information.server_address, connection_information.client_address, response);
}

pub fn on_data_sm_resp(response: data_sm_resp, connection_information: &SmppConnectionInformation, _session_id: &String)  {
...
pub fn on_esme_bound(_esme: ESME, _session_id: &String) {

}

pub fn on_esme_unbound(_session_id: &String) {
