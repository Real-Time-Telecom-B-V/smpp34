...
impl bind_transmitter {
    ...
    pub(crate) fn new(sequence_number: u32, system_id: String, password: String, system_type: String, interface_version: u8, addr_ton: u8, addr_npi: u8, address_range: String) -> bind_transmitter {
